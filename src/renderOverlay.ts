...
export function renderOverlay(
  ...
  for (let i = 0; i < 5; i++) {
    playerLeft(ctx, 25, 1080 - 25 - i * 115, i != 3 ? true : false);
  }
}
...
export { type GameData, type PlayerData, type LoadoutData, type AbilityData, type Gun, type Round, shownInformation };

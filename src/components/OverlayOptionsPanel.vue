...
const previewGameData = ref<GameData>({
  ...
  blueScore: 6,
  redPlayers: [
    { name: "Player 1", tagline: "bot", agent: "Fade", health: 100, loadout: { sidearm: { name: "Classic"}, firearm: { name: "Vandal" }, shield: 50}, credits: 4600, abilities: { Ability1: { maxUses: 1, remainingUses: 0 }, Ability2: { maxUses: 1, remainingUses: 1 }, Signature: { maxUses: 1, remainingUses: 0 }, Ultimate: { maxUses: 6, remainingUses: 4 }}, KDA: [23, 10, 14], alive: false},
    { name: "Player 2", tagline: "bot", agent: "Cypher", health: 100, loadout: { sidearm: { name: "Classic"}, firearm: { name: "Vandal" }, shield: 50}, credits: 4600, abilities: { Ability1: { maxUses: 1, remainingUses: 1 }, Ability2: { maxUses: 1, remainingUses: 1 }, Signature: { maxUses: 1, remainingUses: 1 }, Ultimate: { maxUses: 6, remainingUses: 3 }}, KDA: [23, 10, 14], alive: true},
    { name: "Player 3", tagline: "bot", agent: "Neon", health: 100, loadout: { sidearm: { name: "Classic"}, firearm: { name: "Vandal" }, shield: 50}, credits: 4600, abilities: { Ability1: { maxUses: 1, remainingUses: 0 }, Ability2: { maxUses: 1, remainingUses: 0 }, Signature: { maxUses: 1, remainingUses: 0 }, Ultimate: { maxUses: 6, remainingUses: 2 }}, KDA: [23, 10, 14], alive: true},
    { name: "Player 4", tagline: "bot", agent: "Astra", health: 100, loadout: { sidearm: { name: "Classic"}, firearm: null, shield: 50}, credits: 4600, abilities: { Ability1: { maxUses: 1, remainingUses: 1 }, Ability2: { maxUses: 1, remainingUses: 1 }, Signature: { maxUses: 1, remainingUses: 1 }, Ultimate: { maxUses: 6, remainingUses: 1 }}, KDA: [23, 10, 14], alive: true},
    { name: "Player 5", tagline: "bot", agent: "Reyna", health: 100, loadout: { sidearm: { name: "Classic"}, firearm: { name: "Vandal" }, shield: 50}, credits: 4600, abilities: { Ability1: { maxUses: 1, remainingUses: 0 }, Ability2: { maxUses: 1, remainingUses: 0 }, Signature: { maxUses: 1, remainingUses: 1 }, Ultimate: { maxUses: 6, remainingUses: 2 }}, KDA: [23, 10, 14], alive: true}
  ],
  bluePlayers: [
    { name: "Player 6", tagline: "bot", agent: "Chamber", health: 100, loadout: { sidearm: { name: "Classic"}, firearm: { name: "Vandal" }, shield: 50}, credits: 4600, abilities: { Ability1: { maxUses: 1, remainingUses: 0 }, Ability2: { maxUses: 1, remainingUses: 1 }, Signature: { maxUses: 1, remainingUses: 1 }, Ultimate: { maxUses: 6, remainingUses: 5 }}, KDA: [23, 10, 14], alive: true},
    { name: "Player 7", tagline: "bot", agent: "Killjoy", health: 100, loadout: { sidearm: { name: "Classic"}, firearm: { name: "Vandal" }, shield: 50}, credits: 4600, abilities: { Ability1: { maxUses: 1, remainingUses: 1 }, Ability2: { maxUses: 1, remainingUses: 1 }, Signature: { maxUses: 1, remainingUses: 1 }, Ultimate: { maxUses: 6, remainingUses: 6 }}, KDA: [23, 10, 14], alive: true},
    { name: "Player 8", tagline: "bot", agent: "KAY/O", health: 100, loadout: { sidearm: { name: "Classic"}, firearm: { name: "Vandal" }, shield: 50}, credits: 4600, abilities: { Ability1: { maxUses: 1, remainingUses: 0 }, Ability2: { maxUses: 1, remainingUses: 0 }, Signature: { maxUses: 1, remainingUses: 1 }, Ultimate: { maxUses: 9, remainingUses: 7 }}, KDA: [23, 10, 14], alive: true},
    { name: "Player 9", tagline: "bot", agent: "Jett", health: 100, loadout: { sidearm: { name: "Classic"}, firearm: { name: "Vandal" }, shield: 50}, credits: 4600, abilities: { Ability1: { maxUses: 1, remainingUses: 1 }, Ability2: { maxUses: 1, remainingUses: 1 }, Signature: { maxUses: 1, remainingUses: 1 }, Ultimate: { maxUses: 6, remainingUses: 4 }}, KDA: [23, 10, 14], alive: false},
    { name: "Player 0", tagline: "bot", agent: "Iso", health: 100, loadout: { sidearm: { name: "Classic"}, firearm: { name: "Vandal" }, shield: 50}, credits: 4600, abilities: { Ability1: { maxUses: 1, remainingUses: 0 }, Ability2: { maxUses: 1, remainingUses: 1 }, Signature: { maxUses: 1, remainingUses: 0 }, Ultimate: { maxUses: 6, remainingUses: 3 }}, KDA: [23, 10, 14], alive: false}
  ],
  redSide: "defense",
  blueSide: "attack",
  live: {
